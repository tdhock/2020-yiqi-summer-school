...
observations, each one a soil sample with $D=60$ features.
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{figure-proda-cv-data-map}

  \includegraphics[width=\textwidth]{figure-proda-cv-some-out}
    
  \caption{cross-validation for predicting climate model parameters}
  \label{fig:proda-cv}
\end{figure}
