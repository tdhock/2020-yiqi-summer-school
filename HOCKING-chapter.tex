...
train/test splits that we used to estimate mean and variance
of prediction accuracy for these models (the ``zip.test'' file was
...
outputs. Furthermore it is clear that the dense neural network is
slightly (not significantly) more accurate than the linear model, and
the sparse/convoluational neural network is significantly more 
accurate than the others (Figure~\ref{fig:test-accuracy}, right).
